...
import com.workshop.management.frontend.components.AvatarField;
import com.workshop.management.frontend.data.UserDetails;
import com.workshop.management.frontend.data.UserDetailsService;
...
public class MainView extends VerticalLayout {
    ...
    public MainView(@Autowired UserDetailsService service) {
        ...
        submitButton.addClickListener(e -> {
            ...
            } catch (UserDetailsService.ServiceException ex) {
